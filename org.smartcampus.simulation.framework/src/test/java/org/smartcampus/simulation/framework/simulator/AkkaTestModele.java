 ...
 * - Pour savoir comment tester des Acteurs. C'est en Scala mais la logique derrière est
 * bien expliquée:
        ...
        new JavaTestKit(system) {
            {
                ...
                subject.tell(probe.getRef(), this.getRef());
                // await the correct response
                this.expectMsgEquals(duration("1 second"), "done");
